...
public class ReviewEventConsumer {
    ...
    public void consume(String message) {
        try {
            ...
            if (payload == null || payload.getStoreId() == null || payload.getAverageRating() == null || payload.getReviewCount() == null) {
            ...
            log.warn("review.events.v1 역직렬화 실패 — 메시지 버림. message={}", message, e);
        } catch (Exception e) {
            log.error("review.events.v1 처리 실패. message={}, error={}", message, e.getMessage(), e);
